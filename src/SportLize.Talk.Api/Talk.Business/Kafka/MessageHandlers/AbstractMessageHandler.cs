...
{
    public abstract class AbstractMessageHandler<TMessageDTO> : AbstractOperationMessageHandler<TMessageDTO, IRepository> where TMessageDTO : class, new()
    {
    ...
    public abstract class AbstractMessageHandler<TMessageDTO, TDomainDTO> : AbstractOperationMessageHandler<TMessageDTO, TDomainDTO, IRepository> where TMessageDTO : class, new() where TDomainDTO : class, new()
    {
